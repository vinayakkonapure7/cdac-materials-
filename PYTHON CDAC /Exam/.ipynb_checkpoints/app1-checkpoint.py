...
students = [
    {"rollno": 11, "name": "James", "GPA": 6.7, "branch": "E&C"},
    {"rollno": 24, "name": "Rahul", "GPA": 6.8, "branch": "Computers"},
    {"rollno": 37, "name": "Rohini", "GPA": 8.5, "branch": "AI/ML"},
]
...
def export_as_json():
    ...
    with open(filename, "wt") as f1:
        json.dump(students, f1, indent=3)
